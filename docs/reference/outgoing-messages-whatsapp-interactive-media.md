...
```json
{
  "openapi": "3.0.0",
  "paths": {
    "/whatsapp/message/interactive/media": {
      "post": {
        "operationId": "outgoing-messages-whatsapp-interactive-media",
        "summary": "Send Whatsapp Interactive Media Message",
        "description": "Send Whatsapp Interactive Button Message with media header (image, video or document).",
        "tags": [
          "Outgoing Messages"
        ],
        "parameters": [],
        "requestBody": {
          ...
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/SendWhatsappInteractiveMediaMessageDto"
              }
            }
          }
        },
  ...
  "components": {
    ...
    "schemas": {
      ...
      "InteractiveMediaReplyButtonsContent": {
        "title": "Reply buttons",
        "type": "object",
        "properties": {
          "body": {
          ...
          "fileName": {
            "type": "string",
            "description": "Optional file name to be shown for document media. If not provided for documents, a default name will be used.",
            "example": "image.jpeg"
          },
          "mediaUrl": {
            "type": "string",
            "description": "Public URL of the media to be used as interactive message header.",
            "example": "https://www.example.com/assets/blue-echeveria.jpeg"
          },
          "mediaType": {
            "type": "string",
            "description": "MIME type of the media. Supported: image/jpeg, image/png, video/mp4, application/pdf.",
            "enum": [
              "image/jpeg",
              "image/png",
              "video/mp4",
      ...
      "InteractiveMediaCtaButtonContent": {
        "title": "URL button",
        "type": "object",
        "properties": {
          "body": {
      ...
      "SendWhatsappInteractiveMediaMessageDto": {
        ...
        "properties": {
          ...
          "content": {
            "description": "Interactive media message to be sent",
            "oneOf": [
              {
                "$ref": "#/components/schemas/InteractiveMediaReplyButtonsContent"
              },
              {
                "$ref": "#/components/schemas/InteractiveMediaCtaButtonContent"
              }
            ]
          }
        },
